...
1. Open a terminal and navigate to the `smart-contract` folder:
   ```bash
   cd crypto-wallet-project/smart-contract
   ```
...
4. Set up your environment variables:
   Update `hardhat.config.js` with your Sepolia RPC URL (you can get one from Alchemy or Infura) and your MetaMask private key.
...
6. **IMPORTANT:** After deployment, the terminal will output the deployed contract address. Copy this address and update the `CONTRACT_ADDRESS` variable at the top of `crypto-wallet-project/frontend/app.js`.

### 2. Frontend Setup

1. Open a new terminal and navigate to the `frontend` directory:
   ```bash
   cd crypto-wallet-project/frontend
   ```
